...
const ingredient_disappear_tween_duration = 1
...
const food_creation_time: float = 3
...
func has_halted() -> bool:
	var output_destination_food_count_offset = output_offset_per_food * food_creation_index
	var actual_output_dest = output_destination_pos + output_destination_food_count_offset
	var movement_halted = is_output and position.x < actual_output_dest
